...
<html lang="en">
  <head>
    ...
    <title><?php bloginfo( 'description' ); ?></title>  <!-- название сайта может менять заказчик в настройках вп -->
      ...
      <div class="header__inner">
        <img src="<?php bloginfo( 'template_url' ); ?>/assets/img/home.png" alt="" />
          <div class="header__name">
            <?php the_field('header__name')?> <!-- изменяемое название-->
          </div>
          <a class="phone" href="tel:+75852772217">
            <?php the_field('phone')?>
          </a>

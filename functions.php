...
/* function timber_scripts() {
  ...
  array(jquery), null, true ); //этот скрипт загружается после того, как загрузится jquery, это жизненно необходимо

  wp_enqueue_script( 'mian-script', get_template_directory_uri() .'/assets/js/main.js',
  array(jquery), null, true );

} подключение магнифик папап*/
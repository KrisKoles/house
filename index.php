...
<?php endif; ?>
        ...
        <div class="download">
          <img class="home" src="<?php bloginfo( 'template_url' ); ?>/assets/img/home-dowload.png" alt="" />
          <div class="download__link">
            <a href="<?php the_field('download__link') ?>" download>
            <?php the_field('download__link-text')?>СКАЧАТЬ ВЕСЬ КАТАЛОГ ДОМОВ</a>
          </div>
        </div>
        <div class="container">
        <div class="gallery">
